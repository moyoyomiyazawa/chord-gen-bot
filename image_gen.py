...
def chord_text_to_image(text=''):
  # 背景画像

  image = Image.open(os.path.join(DIR, 'bgimage.png'))
  draw = ImageDraw.Draw(image)

  # テキストが背景画像の幅に収まるようにフォントサイズを調整
  font_size = 50
  font = ImageFont.truetype(os.path.join(DIR, 'fonts/Noto_Sans_JP/NotoSansJP-Black.otf'), size=font_size)
  ...
  # 画像を保存
  image.save(os.path.join(DIR, 'chord_image.png'))
