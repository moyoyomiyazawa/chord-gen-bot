...
def generate_video_from_mention_tweet(mention: object, basedir):
  imagepath = os.path.join(basedir, '/tmp/chord_image.png')
  audiopath = os.path.join(basedir, '/tmp/chord_progression.wav')
  outputpath = os.path.join(basedir, '/tmp/output.mp4')
